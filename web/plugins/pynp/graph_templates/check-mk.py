...
check_mk_process_time = {
    'opt' : {
        ...
        'vertical-label': "time (s)"},
    'def' : [
        'DEF:user_time=%s:1:MAX' % rrd_file['user_time'],
        ...
        'DEF:system_time=%s:1:MAX' % rrd_file['system_time'],
        ...
        'DEF:children_user_time=%s:1:MAX' % rrd_file['children_user_time'],
        ...
        'DEF:children_system_time=%s:1:MAX' % rrd_file['children_system_time'],
